...
@Component
public class ProibeNomeEstadoEPaisDuplicadoValidator implements Validator {

    private EstadoRepository estadoRepository;

    public ProibeNomeEstadoEPaisDuplicadoValidator(EstadoRepository estadoRepository) {
